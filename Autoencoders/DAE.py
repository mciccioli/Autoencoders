...
class AutoencoderDAE:
    ...
    def __init__(self, data, eta, beta, division_layer, momentum, momentum_factor, adaptive_learning, adaptive_learning_epochs, adaptive_learning_a, adaptive_learning_b):
        ...
        self.probabilityDAE = 0.2
        self.completeNoiseChange = False
    ...
    def add_noise(self, data):
        ...
        if aux_rand < self.probabilityDAE:
            if data == 1.0:
                if self.completeNoiseChange:
                    data = -1.0
            else: 
                data = 1.0
        return data
        ...
        while current_error != 0  and epoch < epochs:
            ...
            for mu in range(len(data)):
                ...
                for k in range(len(data[0])):
                    self.activations[0][k+1] = self.add_noise(data[mu][k])
